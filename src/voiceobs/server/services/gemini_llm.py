...
class GeminiLLMService(LLMService):
    ...
    Uses the Google Gemini API via langchain for structured output generation.
    ...
    def __init__(self) -> None:
        ...
        if not LLM_AVAILABLE:
            raise ValueError(
                "LLM dependencies not available. Install with: pip install langchain-google-genai"
            )
